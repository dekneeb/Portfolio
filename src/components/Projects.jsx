        ...
        <div className='projects' id='projects'>
            ...
            <div className='thumbnail'>
                ...
                <div className='overlay'>
                    ...
                    <div className='words'>A search engine for nearby Breweries. Users can favorite certain breweries and keep a running list of ones already visited, as well as directly access websites and get directions. Individual project week 9.</div>
                </div>
                </a>
            </div>
            <div className='thumbnail'>
                ...
                <div className='overlay'>
                    ...
                    <div className='words'>Niche resale website for weddings. Users can comment and direct/private message for exchange of items. Individual project week 12.</div>
